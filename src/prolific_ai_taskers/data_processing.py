...
def process_preferences(responses_df: pd.DataFrame, participants_per_task: int,
    ...
    """
    Process Prolific responses into preference tuning dataset.
    ...
    # Create preference tuning dataset with majority voting
    ...
    print(f"✅ Created preference tuning dataset: {len(rlhf_data)} pairs ({ties} ties excluded)")
