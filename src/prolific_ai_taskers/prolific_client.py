...
class ProlificClient:
    ...
    def create_study(self, task_name: str, internal_name: str, description: str, 
                     data_collection_method: str, batch_id: str, participants_per_task: int,
                     study_labels: List[str], estimated_completion_time: int, max_time: int,
                     reward: int, device_compatibility: List[str], 
                     age_cfg: int, country_choice_ids: List[int], # TODO generalize for filters
        ...
        payload = {
            ...
            "filters": [
                ...
                #    "selected_values": ["0"] # Qualified AI taskers
                #},

                {
                    "filter_id": "age", 
                    "selected_range": age_cfg
                },

                {
                    "filter_id": "current-country-of-residence", 
                    "selected_values": country_choice_ids
                },
            ],
        }
